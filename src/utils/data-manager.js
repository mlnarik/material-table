    ...
    changeByDrag(result) {
        ...
        if (
            ...
            const sorted = this.columns
                .sort(
                    (a, b) => a.tableData.columnOrder - b.tableData.columnOrder
                )
                            ...
                            this.filteredData = this.filteredData.filter(
                                (row) => {
                                    ...
                                    if (currentHour) {
                                        ...
                                        return (
                                            currentHour === currentHourToCompare
                                        );
                                    }
            ...
            (result, currentRow) => {
                ...
                object = groups.reduce((o, colDef) => {
                    const value =
                        ...
                        byString(currentRow, colDef.field);
    ...
    treefyData() {
        ...
        this.data.forEach((rowData) => {
            if (
                !this.searchText &&
                !this.columns.some(
                    (columnDef) => columnDef.tableData.filterValue
                )
            ) {
            ...
            if (
                ...
                this.searchedData.indexOf(rowData) < 0
            ) {
            ...
            const sortGroups = (list, columnDef) => {
                if (columnDef.customSort) {
                    ...
                    return list.sort(
                        columnDef.tableData.groupSort === "desc"
                            ? (a, b) =>
                                  this.sort(b.value, a.value, columnDef.type)
                            : (a, b) =>
                                  this.sort(a.value, b.value, columnDef.type)
                    );
                }
            };
